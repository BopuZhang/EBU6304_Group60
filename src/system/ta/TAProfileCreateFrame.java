...
public class TAProfileCreateFrame extends JFrame {
    ...
    private void initUI() {
        ...
        saveBtn = UIHelper.createButton("Save Profile", SUCCESS_GREEN);
    ...
    private JPanel createHeaderPanel() {
        ...
        JPanel iconPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gp = new GradientPaint(0, 0,
                        new Color(139, 92, 246), getWidth(), getHeight(),
                        new Color(79, 70, 229));
                g2.setPaint(gp);
        ...
        JLabel title = new JLabel("Create Personal Profile");
        title.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 20));
        title.setForeground(TEXT_DARK);
        title.setAlignmentX(Component.LEFT_ALIGNMENT);
        textPanel.add(title);
        textPanel.add(Box.createRigidArea(new Dimension(0, 2)));
        JLabel subtitle = new JLabel("Fill in your profile information to get started");
    ...
    private JPanel createFormSection() {
        ...
        gbc.gridy = row;
        gbc.gridx = 0;
        gbc.insets = new Insets(6, 8, 2, 16);
        JLabel sidLabel = new JLabel("Student ID (9 digits)");
        ...
        studentIdField.setPreferredSize(fieldDim);
        ...
        studentIdErrorLabel = new JLabel(" ");
        studentIdErrorLabel.setFont(new Font(Font.SANS_SERIF, Font.PLAIN, 10));
        studentIdErrorLabel.setForeground(DANGER_RED);
        gbc.gridy = row;
        gbc.gridx = 1;
        ...
        gbc.gridy = row;
        gbc.gridx = 0;
        gbc.insets = new Insets(8, 8, 4, 16);
        ...
        gbc.gridy = row;
        gbc.gridx = 0;
        gbc.insets = new Insets(12, 8, 2, 16);
